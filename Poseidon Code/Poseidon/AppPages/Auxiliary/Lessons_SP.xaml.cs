...
{
    /// <summary>
    /// Interaction logic for Lessons_SP.xaml
    /// </summary>
    public partial class Lessons_SP : Page
    {
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ΜΑΘΗΜΑΤΑ_ΣΠ lessons = row as ΜΑΘΗΜΑΤΑ_ΣΠ;
                db.ΜΑΘΗΜΑΤΑ_ΣΠs.DeleteOnSubmit(lessons);
            }
        }
        ...
        private void ShowSelected()
        {
            ...
            var lessons = from dbe in db.ΜΑΘΗΜΑΤΑ_ΣΠs
                                      where dbe.ΕΞΑΜΗΝΟ == selected_term.ΕΞΑΜΗΝΟ_ΚΩΔ
                                      orderby dbe.ΜΑΘΗΜΑ
                                      select dbe;

            ObservableCollection<ΜΑΘΗΜΑΤΑ_ΣΠ> oce = new ObservableCollection<ΜΑΘΗΜΑΤΑ_ΣΠ>(lessons.ToList());
        ...
        private void lessonsGrid_RowEditEnded(object sender, GridViewRowEditEndedEventArgs e)
        {
            ...
            if (e.EditOperationType == GridViewEditOperationType.Insert)
            {
                ...
                ΜΑΘΗΜΑΤΑ_ΣΠ lesson = row.Item as ΜΑΘΗΜΑΤΑ_ΣΠ;
                ...
                db.ΜΑΘΗΜΑΤΑ_ΣΠs.InsertOnSubmit(lesson);
            }
        ...
        {
            var recs = (from p in db.ΜΑΘΗΜΑΤΑ_ΣΠs
        ...
        private void lessonsGrid_RowValidating(object sender, GridViewRowValidatingEventArgs e)
        {
            ...
            ΜΑΘΗΜΑΤΑ_ΣΠ lesson_row = e.Row.DataContext as ΜΑΘΗΜΑΤΑ_ΣΠ;
        ...
        {
            LessonsSP radwindow = new LessonsSP();
            radwindow.Show();
