...
{
    /// <summary>
    /// Interaction logic for Classes_SM.xaml
    /// </summary>
    public partial class Classes_SM : Page
    {
        ...
        public void LoadData()
        {
            ...
            var classes = from t in db.ΤΜΗΜΑΤΑ_ΣΜs
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ΤΜΗΜΑΤΑ_ΣΜ tmima = row as ΤΜΗΜΑΤΑ_ΣΜ;
                if (ValidateDeleteClass(tmima))
                {
                    db.ΤΜΗΜΑΤΑ_ΣΜs.DeleteOnSubmit(tmima);
                }
            }
        }
        ...
        private void dataGrid_RowEditEnded(object sender, GridViewRowEditEndedEventArgs e)
        {
            ...
            if (e.EditOperationType == GridViewEditOperationType.Insert)
            {
                ...
                ΤΜΗΜΑΤΑ_ΣΜ tmima = row.Item as ΤΜΗΜΑΤΑ_ΣΜ;

                // these two methods do the database udpating
                db.ΤΜΗΜΑΤΑ_ΣΜs.InsertOnSubmit(tmima);            // insert new row into collection
            }
        }
        ...
        {
            ΤΜΗΜΑΤΑ_ΣΜ tmima = e.Row.DataContext as ΤΜΗΜΑΤΑ_ΣΜ;
            ...
            string name = (string)tmima.ΤΜΗΜΑ_ΟΝΟΜΑΣΙΑ;
            if (String.IsNullOrWhiteSpace(name))
            {
                e.IsValid = false;
        ...
        private bool ValidateDeleteClass(ΤΜΗΜΑΤΑ_ΣΜ tmima)
        {
            return true;
        }
