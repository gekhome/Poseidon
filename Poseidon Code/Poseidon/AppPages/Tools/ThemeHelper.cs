...
namespace Poseidon.AppPages.Tools
{
    class ThemeHelper
    {
        ...
        private static readonly ThemeHelper instance = new ThemeHelper();
        ...
        private static readonly string[] allThemes = new string[]
        {
            ...
            "Windows7",
            "Expression_Dark",
            ThemeHelper.Office2013DefaultThemeName,
            ThemeHelper.Office2013LightGrayThemeName,
            ThemeHelper.Office2013DarkGrayThemeName
        };
        ...
        public void EnsureResourcesForTheme(string themeName, string[] resourcesPaths = null)
        {
            ...
            Action resetApplicationResources = () =>
            {
                ...
                foreach (string resourcePath in resourcesPaths)
                {
                    ...
                    if (themeName.Contains(ThemeHelper.Office2013DefaultThemeName))
                    {
            ...
            this.currentTheme = themeName.Contains(ThemeHelper.Office2013DefaultThemeName) ? this.currentOffice2013ThemeName : themeName;
        ...
        private string GetProperOffice2013ThemeName(string themeName)
        {
            if (!this.isOffice2013ColorPresetLoaded)
            {
                ...
                switch (themeName)
                {
                    case (ThemeHelper.Office2013LightGrayThemeName):
                        {
                            Office2013Palette.LoadPreset(Office2013Palette.ColorVariation.LightGray);
                            themeName = ThemeHelper.Office2013DefaultThemeName;
                        }
                        break;
                    case (ThemeHelper.Office2013DarkGrayThemeName):
                        {
