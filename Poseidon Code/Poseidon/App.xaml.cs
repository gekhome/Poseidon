...
namespace Poseidon
{
    ...
    public partial class App : Application
    {
        ...
        public static void HandleException(Exception ex)
        {
            if (ex == null)
                return;
            string displayMessage = Poseidon.Properties.Resources.GeneralExceptionPrompt + Environment.NewLine + Environment.NewLine;
...
#endif
            MessageBox.Show(displayMessage, Poseidon.Properties.Resources.GeneralExceptionTitle, MessageBoxButton.OK, MessageBoxImage.Error);
        }
